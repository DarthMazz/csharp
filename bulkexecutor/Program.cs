...
namespace bulkexecutor
{
    class Program
    {
        ...
        string PrimaryKey = "aH8gP6ddcQyjtbhOOmUnz5V4bQt65koWjTI7UwYQ3eM0makE8kyOdxo1hMSGOMwV9Pdp455NbiYvzQ0UibitqA==";
        ...
        public async Task GetStartedDemoAsync()
        {
            ...
            this.cosmosClient = new CosmosClient(EndpointUri, PrimaryKey, new CosmosClientOptions() { AllowBulkExecution = true });
